...
|---|---|---|---|
| [t3code at `41adccc`](https://github.com/pingdotgg/t3code/tree/41adccc83e819c286dcdf32cd8b5f55af8bb0b49) | Adapt contracts only | Provider SPI, serialized command/event/projection flow, idempotent receipts, runtime-event normalization, drainable tests, isolated instance teardown | ONE BOX keeps workspace, file, VCS, terminal, session, credential, route, budget, Page IR, candidate, approval, apply, and release authority; no upstream runtime or dependency is imported; see the [closure receipt](obx-p180-source-adoption-closure-2026-08-31.md) |
| [MishMash at `334e4ba`](https://github.com/ZeroSum-Solutions/mishmash/tree/334e4ba4e01071825686a6793c56c6bc482fa951) | Adapt internal patterns only | Data-defined adapters, normalized events, explicit session-handle vocabulary, side-effect-aware retry, isolated skill staging | No package, daemon, database, persistence, UI, release system, provider config, memory/collaboration behavior, or authority is copied; see the [closure receipt](obx-p180-source-adoption-closure-2026-08-31.md) |
