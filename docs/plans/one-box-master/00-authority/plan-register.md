...
| Team, agents, skills, browser, and desktop shell | [`2026-08-29-canvas-operating-environment-design.md`](../../../superpowers/specs/2026-08-29-canvas-operating-environment-design.md) and [`ai-teammate-operating-model.md`](../04-operating-environment/ai-teammate-operating-model.md) | The wider architecture remains draft. The [scoped registry](scoped-implementation-authorizations.json) is the sole implementation-authority source: it preserves `OBX-AUTH-ATF-001`, the exact T01/T02 child-ticket exception records, and the separate reserved, pre-activation T03/T04 sibling grants. T03/T04 cannot activate until their exact receipts validate; no record grants T05+, provider/runtime, deployment, release, or wider `OBX-P180`/`OBX-P310` authority. |
