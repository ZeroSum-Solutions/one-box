...
| Team, agents, skills, browser, and desktop shell | [`2026-08-29-canvas-operating-environment-design.md`](../../../superpowers/specs/2026-08-29-canvas-operating-environment-design.md) and [`ai-teammate-operating-model.md`](../04-operating-environment/ai-teammate-operating-model.md) | Architecture drafts. Persistent teammate identity means durable role and handoff context, not a running process, inherited authority, or human approval. They cannot weaken the website or appointment contracts. |
