...
| Narrow Release 1 and re-delivery | [`release-1-contract.md`](../01-foundation/release-1-contract.md) | Owner-approved contract, accepted 2026-09-02; implementation follows the scoped registry. Provider selection, deployment, client invitation, and appointment activation remain unauthorized. |
| Release 1 compatibility | [`release-1-compatibility-matrix.md`](../01-foundation/release-1-compatibility-matrix.md) | Owner-approved contract, accepted 2026-09-02; implementation follows the scoped registry. Baseline evidence and owner selections remain tickets. |
