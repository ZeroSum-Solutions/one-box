...
status: blocked
priority: P0
epic: Provider and appointments
owner-role: product, operations, and appointment owners
depends-on: OBX-P110, OBX-P130, OBX-P140, OBX-P190, OBX-P250
requirements: EOS-019
evaluations: PROG-EVAL-PROVIDER-001
---

# OBX-P195: Select provider and preserve appointment independence

## Outcome

Provider selection uses current conformance evidence and website operations cannot activate, restore, or corrupt appointment authority.

## Readiness gate

P6 owner selection and separate appointment PRD/eval/plan/threat/activation authorization are required.
