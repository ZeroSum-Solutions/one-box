...
status: blocked
priority: P0
epic: P3 client review
owner-role: client review owner
depends-on: OBX-P200, OBX-P210, OBX-P130, OBX-P170
requirements: P3, EOS-007
evaluations: PROG-EVAL-CLIENT-001, PROG-EVAL-UX-BASELINE-001
---

# OBX-P220: Plan P3 client review origin and decisions

## Outcome

A client reviews exactly one candidate through a least-privileged, revocable origin.

## Readiness gate

Guest scope, invitation, candidate lock, expiry, revocation, stale approval, and origin tests must pass.
